    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            Text("Snowdays Foundation  |  2015 - 2023")
                ...
                .padding(.bottom, 1)
                .slideFadeIn(show: appEnvironment.contentAppear[1], offset: 20)
            ...
            .padding(.bottom, 10)
            .slideFadeIn(show: appEnvironment.contentAppear[1], offset: 15)
            ...
            Text("Nike  |  2018 - 2021")
                ...
                .foregroundColor(.primary.opacity(0.8))
                .padding(.bottom, 1)
                .slideFadeIn(show: appEnvironment.contentAppear[2], offset: 20)
            VStack(alignment: .leading, spacing: 5) {
            ...
            .foregroundColor(.primary.opacity(0.7))
            .padding(.bottom, 10)
            .slideFadeIn(show: appEnvironment.contentAppear[2], offset: 15)
            ...
            Text("Anthropologie  |  2017 - 2018")
                ...
                .foregroundColor(.primary.opacity(0.8))
                .padding(.bottom, 1)
                .slideFadeIn(show: appEnvironment.contentAppear[3], offset: 20)
            VStack(alignment: .leading, spacing: 5) {
            ...
            .foregroundColor(.primary.opacity(0.7))
            .padding(.bottom, 10)
            .slideFadeIn(show: appEnvironment.contentAppear[3], offset: 15)
            
            Text("Dr.Martens  |  2017 - 2018")
                .font(.headline)
                .foregroundColor(.primary.opacity(0.8))
                .slideFadeIn(show: appEnvironment.contentAppear[4], offset: 20)
            Text("**•** Assistant Store Manager")
                .font(.subheadline)
                .foregroundColor(.primary.opacity(0.7))
                .padding(.bottom, 10)
                .slideFadeIn(show: appEnvironment.contentAppear[4], offset: 15)
            
            Text("AllSaints  |  2016 - 2017")
                .font(.headline)
                .foregroundColor(.primary.opacity(0.8))
                .slideFadeIn(show: appEnvironment.contentAppear[5], offset: 20)
            Text("**•** Brand Stylist")
                .font(.subheadline)
                .foregroundColor(.primary.opacity(0.7))
                .padding(.bottom, 10)
                .slideFadeIn(show: appEnvironment.contentAppear[5], offset: 15)
            
            Text("Urban Outfitters  |  2012 - 2016")
                .font(.headline)
                .foregroundColor(.primary.opacity(0.8))
                .padding(.bottom, 1)
                .slideFadeIn(show: appEnvironment.contentAppear[6], offset: 20)
            VStack(alignment: .leading, spacing: 5) {
                Text("**•** Visual Merchandising Team Lead")
            ...
            .foregroundColor(.primary.opacity(0.7))
            .padding(.bottom, 10)
            .slideFadeIn(show: appEnvironment.contentAppear[6], offset: 15)
                ...
                .onTapGesture {
                    ...
                    DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) {
                        withAnimation(.easeInOut(duration: 0.8)) {
                            appEnvironment.selectedModal = .coverLetter
                        }
                    }
                }
        }
